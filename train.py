...
def train():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="models/CDial-GPT2_LCCC-base", help="Path or URL of the model")
    ...
    parser.add_argument("--data_path", type=str, default="data/hke_decode_demo.json",
    ...
    parser.add_argument("--knowledge_mask", type=str, default="",
                        help="knowledge_mask")
    parser.add_argument('--log_file', '-log_file', type=str, default="debug", help="Output logs to a file under this path")
    ...
    parser.add_argument("--valid_steps", type=int, default=32500, help="Perfom validation every X steps")
    ...
    if args.local_rank in [-1, 0]:
        ...
        trainer.add_event_handler(Events.EPOCH_COMPLETED, checkpoint_handler, {
            'train_model': getattr(model, 'module', model)})  # "getattr" take care of distributed encapsulation
...
# python train.py --pretrained --scheduler linear --gpt2 # 使用单个GPU进行训练